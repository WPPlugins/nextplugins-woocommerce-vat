	...
	public static function get_settings() {
		...
		$settings = array(
			...
			array(
				...
				'default' => 'no',
				'custom_attributes' => array('onclick' => 'jQuery("input:radio[name=next_plugins_wc_vat_checkout_position]:first").attr(\'checked\', true);jQuery("input:radio[name=next_plugins_wc_vat_account_position]:first").attr(\'checked\', true);document.getElementById("mainform").submit();'),
			),
		);
